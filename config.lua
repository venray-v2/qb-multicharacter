...
Config.DefaultSpawn = vector3(160.14, -998.18, 29.35) -- Default spawn coords if you have start apartments disabled -- Default spawn coords if you have start apartments disabled
